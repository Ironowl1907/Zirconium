...
void OpenGLFrameBuffer::Invalidate() {
    ...
    if (m_ColorAttachmentSpecification.size()) {
        ...
        for (size_t i = 0; i < m_ColorAttachments.size(); i++) {
            ...
            case FramebufferTextureFormat::RGBA8:
                ...
                break;
            case FramebufferTextureFormat::RED_INTEGER:
                Utils::AttachColorTexture(m_ColorAttachments[i], m_Specification.Samples, GL_R32UI, GL_RED_INTEGER,
                                          m_Specification.Width, m_Specification.Height, i);
                break;
            case FramebufferTextureFormat::DEPTH24STENCIL8:
            case FramebufferTextureFormat::None:
    ...
    if (m_ColorAttachments.size() > 1) {
        ZR_CORE_ASSERT(m_ColorAttachments.size() <= 4, "Only supported max 4 color attachments");
    ...
    ZR_ASSERT(status == GL_FRAMEBUFFER_COMPLETE, "Framebuffer is incomplete!");
